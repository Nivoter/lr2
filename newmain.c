...
void Adc_init()
{
    TRISA |=0b11111111; //перевод выводов RA0, RA1, RA2, RA3, RA5 в режим
...
int main(int argc, char** argv)
{
    TRISB0=1;
    TRISB3=0;
    unsigned char i=0; //Номер канала
    unsigned int f=0; //Счетчик для дребезга
    unsigned char g=0; //Флаг нажатия кнопки
    lcd_init();
    Adc_init();
    ...
    while(1)
    {
        ...
        ADCON0bits.CHS=i; // выбор аналогового канала
        inttolcd(0x8B,i);
